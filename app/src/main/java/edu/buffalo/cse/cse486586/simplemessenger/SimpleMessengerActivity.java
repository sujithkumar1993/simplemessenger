...
public class SimpleMessengerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e(TAG,"******* PINGED SERVER TASK METHOD *******");
        } catch (IOException e) {
            /*
        ...
        editText.setOnKeyListener(new OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_DOWN) &&
                    ...
                    Log.e(TAG,"***user pressed ENTER and text is *** "+msg);
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            /*
            Reference links:
            * https://stackoverflow.com/questions/13321740/socket-issue-only-first-message-read
        ...
        protected void onProgressUpdate(String...strings) {
            ...
            Log.e(TAG,"OnProgressUpdate Method ---> String received is"+strReceived);
            TextView remoteTextView = (TextView) findViewById(R.id.remote_text_display);
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                Log.e(TAG,"*** IN CLIENT TASK METHOD *** message to send *** "+msgToSend);

                /*
                 * TODO: Fill in your client code that sends out a message.
                 */

                Log.e(TAG,"*** IN CLIENT TASK METHOD *** Step1");

//                  OutputStreamWriter textOutputStream = new OutputStreamWriter(socket.getOutputStream());
                PrintWriter textOutput = new PrintWriter(socket.getOutputStream(),true);
                textOutput.println(msgToSend);
                socket.close();
